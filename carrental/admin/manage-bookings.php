...
{    
    ...
    if(isset($_REQUEST['eid'])) {
        // Get the 'eid' from the URL to cancel the booking
        $eid = intval($_GET['eid']);
    ...
    if(isset($_REQUEST['aeid'])) {
        // Get the 'aeid' from the URL to confirm the booking
...
<a href="revenue.php?vehicleId=<?php echo htmlentities($result->vid);?>&vehicleName=<?php echo htmlentities($result->BrandName.' '.$result->VehiclesTitle);?>" onclick="return confirm('View revenue for this vehicle?')">View Revenue</a>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php
                                        // Query to fetch booking details from the database
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Action links to confirm or cancel booking -->
                                                <a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>&vehicleId=<?php echo htmlentities($result->vid);?>&vehicleName=<?php echo htmlentities($result->BrandName.' '.$result->VehiclesTitle);?>" onclick="return confirm('Do you really want to Confirm this booking?')">Confirm</a> / 
